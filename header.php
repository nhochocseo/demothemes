    ...
    <head>
      ...
      <link rel="pingback" href="<?php bloginfo( 'pingback_url' ) ?>" />
       <meta name="viewport" content="width=device-width, initial-scale=1">
             <!--[if lt IE 9]-->
    <script src="<?php echo get_template_directory_uri(); ?>/core/js/html5shiv.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/core/js/respond.min.js"></script>
  <!--[endif]-->
      <?php wp_head(); ?>
