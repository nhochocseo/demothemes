	...
	function widget( $args, $instance ) {
		...
		<?php echo $after_title; ?>
			<div class="facebook-box">
				...
				<iframe src="//www.facebook.com/plugins/likebox.php?href=<?php echo $page_url ?>&amp;width=233&amp;height=230&amp;colorscheme=light&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=false&amp;appId=804766489562981" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:230px;" allowTransparency="true"></iframe>
			</div>
	<?php 
		echo $after_widget;
	}
